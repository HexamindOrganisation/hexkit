...
AGENT_ENABLE_LLM=1 bash ../demo/scripts/run-backends.sh   # proxy :8800, agent-server :8880

# this app
npm install
npm run dev                                               # http://localhost:8873
```

Open <http://localhost:8873>, pick an agent from the top bar, and send a
